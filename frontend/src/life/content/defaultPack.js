  ...
  maoyou: [
    ...
    S({
      n1: { line: '工具箱整理好了，效率应该会高一点。今天改哪台好呢。', choices: [
        C('改最喜欢的那台', { bond: 1, stats: { mood: 2 } }, '最喜欢的是这台初代机……有点下不去手。但你说得对，好机体就该被好好对待。', 'n2'),
        C('改最旧的那台', { stats: { explore: 1 } }, '最旧的……这台螺丝都锈了。也好，复活老伙计最有成就感。', 'n2'),
      ] },
      n2: { line: '决定了。你帮我打个下手？今天应该能改完一半。', choices: [
